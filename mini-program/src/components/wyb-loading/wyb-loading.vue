<template>
  <view class="wyb-loading-box" @tap.stop.prevent @touchmove.stop.prevent>
    ...
    >
      <view
        :class="
          type === 'square' ? 'wyb-loading-content' : 'wyb-loading-content-h'
        "
      >
        <view
          :class="type === 'square' ? 'wyb-loading-anim' : 'wyb-loading-anim-h'"
        >
          <view
            v-if="loadingType === 'ring'"
            class="loader-one"
            :style="{
              width: type === 'square' ? '80rpx' : '50rpx',
              height: type === 'square' ? '80rpx' : '50rpx',
              borderTop:
                (type === 'square' ? '4px solid ' : '3px solid ') +
                loadingColor.top,
              borderRight:
                (type === 'square' ? '4px solid ' : '3px solid ') +
                loadingColor.right,
        ...
        <view
          :class="
            type === 'square' ? 'wyb-loading-title' : 'wyb-loading-title-h'
          "
          :style="{
            paddingLeft:
              type === 'rectangle' && loadingType === 'scale-line'
                ? '20rpx'
                : type === 'rectangle'
                ? '40rpx'
                : '0',
